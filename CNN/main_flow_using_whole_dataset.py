...
if __name__ == '__main__':
  ...
  m_path = config.dataset + "_WHOLE_" + str(config.num_epochs) +  "epochs_" + config.model + "_" + config.partition + "_lr " + str(config.lr)
  try:
  ...
  validation_loader = torch.utils.data.DataLoader(dataset=validation_set, batch_size=config.batch_size, shuffle=False)
